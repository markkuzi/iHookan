...
import com.example.ihookan.databinding.DrinksBinding
...
class Drinks : Fragment(){
    ...
    private var binding: DrinksBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = DrinksBinding.inflate(inflater, container, false)
    ...
    private fun loadCategories() {
        productsViewModel.loadProductToCategory("Drinks").observe(viewLifecycleOwner, Observer {
