...
import com.example.ihookan.databinding.MixTobaccoBinding
...
class MixTobacco : Fragment(){

    private var binding: MixTobaccoBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = MixTobaccoBinding.inflate(inflater, container, false)
    ...
    private fun loadCategories() {
        productsViewModel.loadProductToCategory("Mix").observe(viewLifecycleOwner, Observer {
